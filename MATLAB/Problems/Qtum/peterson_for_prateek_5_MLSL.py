...
opt = nlopt.opt(nlopt.G_MLSL_LDS, nnodes)
opt2 = nlopt.opt(nlopt.LN_NELDERMEAD, nnodes)
opt.set_local_optimizer(opt2)

opt.set_min_objective(fun)
opt.set_lower_bounds([0] * 10)
opt.set_upper_bounds([np.pi] * 10)
maxeval = 200000
opt.set_maxeval(maxeval)

init = np.array([0.452639, 2.3341883, 2.4287354, 1.7455251, 0.0107926, 2.9114669, 2.8951466, 0.0505127, 2.9967985, 1.7442851])
