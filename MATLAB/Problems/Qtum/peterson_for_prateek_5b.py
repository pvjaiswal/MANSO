...
class SaneFormatter(argparse.RawTextHelpFormatter, argparse.ArgumentDefaultsHelpFormatter):
    pass


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Quantum", formatter_class=SaneFormatter)
    parser.add_argument("-p", "--points", dest="POI", type=str, required=True, default=[], nargs="+", help="Array of number of events")
    args = parser.parse_args()


points = [float(str) for str in args.POI]
# print(points)
...
init_point = np.hstack(points)
# np.hstack([1.0115898,0.5872988,0.4441217,0.1269637,2.9280776,1.3318367,0.9502918,1.615396,0.702677,2.6990806])
