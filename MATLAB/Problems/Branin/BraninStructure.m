function [minmax, d, m, VarNature, VarBds, FnGradAvail, NumConstraintGradAvail, StartingSol, budget, ObjBd, OptimalSol, NumRngs] = BraninStructure(NumStartingSol)
...
VarBds = [-5,10; 0,15]; % bounds from the description
...
if (NumStartingSol < 0) || (NumStartingSol ~= round(NumStartingSol))
    ...
    if (NumStartingSol == 0)
        ...
        StartingSol = [-5,0] + 15 * rand(d, NumStartingSol)';
    end    
end
