...
for seed in range(1):
    ...
    if not os.path.exists(dirName):
        os.makedirs(dirName)
    np.save("Results/" + Problem + "_" + LSO + "_seed_" + str(seed) + "_D_" + str(d) + "_b_" + str(beta) + "_omega_" + str(omega) + "_n0_" + str(n0) + "_Ob_" + str(OptimBudget) + "_B_" + str(args.B) + ".npy", MANSOP20)
    np.save("Results/" + Problem + "_" + LSO + "_seed_" + str(seed) + "_ND_" + str(d) + "_b_" + str(beta) + "_omega_" + str(omega) + "_n0_" + str(n0) + "_Ob_" + str(OptimBudget) + "_B_" + str(args.B) + ".npy", MANSOP20N)
if LSO == "ASTRODF":
    eng.quit()
    eng1.quit()
